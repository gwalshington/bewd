...
art1 = Artist.create(:name => 'Vincent van Gogh', :nationality => 'Dutch', :dob => '1795', :image => 'http://cdn.theatlantic.com/static/mt/assets/science/vangogh_photo.jpg')
art2 = Artist.create(:name => 'Pablo Picasso', :nationality => 'Spain', :dob => '1686', :image => 'http://cdn.enjoyourholiday.com/wp-content/uploads/2012/10/Picasso-portrait.jpg')
art3 = Artist.create(:name => 'Salvador Dali', :nationality => 'Spain', :dob => '1583', :image => 'http://www.biography.com/imported/images/Biography/Images/Profiles/D/Salvador-Dali-40389-2-402.jpg')
art4 = Artist.create(:name => 'Claude Monet', :nationality => 'French', :dob => '1275', :image => 'http://www.biography.com/imported/images/Biography/Images/Profiles/M/Claude-Monet-WC-9411771-2-402.jpg')
art5 = Artist.create(:name => 'Henri Matisse', :nationality => 'French', :dob => '1376', :image => 'http://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Portrait_of_Henri_Matisse_1933_May_20.jpg/220px-Portrait_of_Henri_Matisse_1933_May_20.jpg')
